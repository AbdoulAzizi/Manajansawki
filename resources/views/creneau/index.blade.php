    ...
    <div class="row" >
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right" style="float: right;margin-top: 10px">
                <a class="btn btn-success" href="{{ route('creneau.create') }}"> Nouveau Créneau </a>
            </div>
        </div>
    </div>
    <p></p>
    ...
    <table class="table table-bordered table-striped">
        ...
        @foreach ($creneaux as $creneau)
            <tr>
                ...
                <td>
                    <form action="{{ action('CreneauxController@destroy' ,$creneau->id)}}" method="POST" >
                        <a class="btn btn-info" href="{{ route('creneau.show',$creneau->id) }}">Voir</a>

                        <a class="btn btn-primary" href="{{ route('creneau.edit',$creneau->id) }}">Modifier</a>
                        @csrf
                        @method('delete')
